    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
            <div class="container px-5">
                <a class="navbar-brand fw-bold" href="#page-top"><img src="{{asset('assets/logo1.png')}}" alt=""width="40"height="40"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <a href="{{URL('/LoginPage')}}"class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0" >
                        <span class="d-flex align-items-center">
                            <i class="bi-chat-text-fill me-2"></i>
                            <span class="small">Sign-Up</span>
                        </span>
            ...
            <div class="container px-5">
                <div class="row gx-5 justify-content-center">
                    <div class="col-xl-8">
                        ...
                        <img src="{{asset('assets/img/tnw-logo.svg')}}" alt="..." style="height: 3rem" />
                    </div>
                </div>
            </div>
        </aside>
